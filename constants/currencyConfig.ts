...
export const SUPPORTED_FIAT_CURRENCIES: Record<string, FiatCurrency> = {
  ...
  BHD: { code: 'BHD', symbol: '\u200E.د.ب\u200E', name: 'Bahraini Dinar', rate: 0.38, locale: 'en-US', format: 'en-US', flag: '🇧🇭' },
  ...
  KWD: { code: 'KWD', symbol: '\u200Eد.ك\u200E', name: 'Kuwaiti Dinar', rate: 0.31, locale: 'en-US', format: 'en-US', flag: '🇰🇼' },
