...
const TOKEN_CONTRACTS: Record<string, Record<string, string>> = {
  ...
  DAI: {
    ...
    'Base Sepolia': '0x3e622317f8C93f7328350cF0B56d9eD4C620C5d6',
    'Polygon Amoy': '0x3e622317f8C93f7328350cF0B56d9eD4C620C5d6',
    'Arbitrum Sepolia': '0x3e622317f8C93f7328350cF0B56d9eD4C620C5d6',
    'Optimism Sepolia': '0x3e622317f8C93f7328350cF0B56d9eD4C620C5d6',
  },
};
