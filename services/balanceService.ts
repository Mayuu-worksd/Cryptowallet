...
const TOKEN_CONTRACTS: Record<string, Record<string, string>> = {
  ...
  INRX: {
    Ethereum: (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x51a5f24560547f587999c331788aC495D40d95ba'),
    Sepolia:  (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x51a5f24560547f587999c331788aC495D40d95ba'),
    Polygon:  '0xd52280A15b30e5EdfFF858E7EC22266604358F26',
    'Polygon Amoy':     '0xd52280A15b30e5EdfFF858E7EC22266604358F26',
    'Base Sepolia':     (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x51a5f24560547f587999c331788aC495D40d95ba'),
    'Arbitrum Sepolia': (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x51a5f24560547f587999c331788aC495D40d95ba'),
    'Optimism Sepolia': (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x51a5f24560547f587999c331788aC495D40d95ba'),
  },
};
