...
const TOKEN_CONTRACTS: Record<string, Record<string, string>> = {
  ...
  INRX: {
    Ethereum: (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x351028A22C876E0431b30921c0dD0a836a14899E'),
    Sepolia:  (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x351028A22C876E0431b30921c0dD0a836a14899E'),
    Polygon:  '0xd52280A15b30e5EdfFF858E7EC22266604358F26',
    'Polygon Amoy':     '0xd52280A15b30e5EdfFF858E7EC22266604358F26',
    'Base Sepolia':     (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x351028A22C876E0431b30921c0dD0a836a14899E'),
    'Arbitrum Sepolia': (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x351028A22C876E0431b30921c0dD0a836a14899E'),
    'Optimism Sepolia': (process.env.EXPO_PUBLIC_CUSTOM_TOKEN || '0x351028A22C876E0431b30921c0dD0a836a14899E'),
  },
};
